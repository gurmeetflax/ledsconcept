  ...
  return (
    <div>
      <section className="container-page py-20 md:py-28">
        ...
        <h1 className="mt-3 max-w-4xl font-display text-4xl text-balance md:text-7xl">
      ...
      <section className="container-page grid gap-4 pb-16 md:grid-cols-4">
        {values.map((v) => (
      ...
      <section className="container-page pb-20">
        <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-10 md:p-14">
          <h2 className="font-display text-3xl md:text-4xl">Madrix Licensed Associates</h2>
